...
async function signup() {
  ...
  if (!data.user) {
    ...
    alert(
      "Account बना है। अगर email confirmation चालू है तो अपना email verify करें।"
    );
...
async function login() {
  ...
  if (profileError) {
    ...
    alert("User खोजने में समस्या हुई।");
  ...
  if (!profile) {
    ...
    alert("यह username मौजूद नहीं है।");
...
async function viewUserProfile(username) {
  ...
  if (error) {
    ...
    alert("Profile load नहीं हो सकी।");
